...
addpath ~/Dropbox/Epilepsykonrad/Pipeline/
addpath ~/Dropbox/Epilepsykonrad/Pipeline/quarantines_Apr/
...
MRIwrite(M, ['',sub,'/xhemi/classifier/',h1,'.',sub,'.NN_Nodes_13_Features_twenty_Pat_29_Layers_for_3T_study_Clusters_minarea50.mgh'])
   end
end
